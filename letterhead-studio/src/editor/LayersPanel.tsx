...
export function LayersPanel({ layers, activeLayerIndex, editor }: LayersPanelProps) {
      ...
      {displayLayers.map((layer, displayIdx) => {
        ...
        return (
          <li
            ...
            className={`studio-layer-row${isSelected ? ' studio-layer-row--selected' : ''}${overDisplayIdx === displayIdx ? ' studio-layer-row-over' : ''}${dragDisplayIdx === displayIdx ? ' studio-layer-row-dragging' : ''}`}
          ...
          >
            ...
            <div className="studio-layer-row-actions">
              <button
                type="button"
                className={`studio-layer-icon-btn${layer.visible ? '' : ' studio-layer-icon-btn--muted'}`}
              ...
              <button
                type="button"
                className={`studio-layer-icon-btn${layer.locked ? ' active' : ''}`}
              ...
              <button
                type="button"
                className="studio-layer-icon-btn studio-layer-icon-btn--danger"
